...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Trajet</a>
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Mon compte</a>
  </div>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding-large">Trajet</a>
  </div>
</div>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  ...
  <div class="leftcolumn">
    <div class="card">
      ...
      <div class="fakeimg" style="height:10%";>
	  <form method="post" action="traitement.php" >
	  
				   <input type="search" placeholder="Départ" name="the_search">
				   
				   
				   
  <input type="search" placeholder="Arriver" name="the_search">
  <input type="date"  name="the_search">
  <button type="submit" name="Mon trajet">Mon Trajet </button>
	  </div>
</header>
